...
There might be some mistakes or straight up conceptual errors, for that I am sorry.  
Anyone is welcome to post an issue or open a pull request to ask for a fix. I will try to be as swift as possible in getting it fixed.

# On HOW to choose a statistic.
